const loginInput = document.querySelector('.trybewarts-login input:nth-child(1)');
const passwordInput = document.querySelector('.trybewarts-login input:nth-child(2)');
